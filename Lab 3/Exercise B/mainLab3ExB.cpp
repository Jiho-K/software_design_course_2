...
template <typename T>
void print(LookupTable<T>& lt);

template <typename T>
void try_to_find(LookupTable<T>& lt, int key);
...
void test_Customer()
  ...
  {
    cout<<"\nCreating and testing Customers Lookup Table <Customer>-...\n";
    LookupTable<Customer> lt;
    ...
    lt.insert(Pair<Customer>(8002, a));
    lt.insert(Pair<Customer>(8004,c));	
    lt.insert(Pair<Customer>(8001,b));
    ...
    LookupTable<Customer>::Iterator it = lt.begin();
...
void test_String()
  ...
  // creating lookuptable for Mystring objects
  {
    ...
    lt.insert(Pair<Mystring> (8002,a));
    lt.insert(Pair<Mystring> (8001,b));
    lt.insert(Pair<Mystring> (8004,c));
    ...
    try_to_find(lt, 8000);
    // test Iterator
    LookupTable<Mystring>::Iterator it = lt.begin();
    cout <<"\nThe first node contains: " <<*it <<endl;
...
void test_integer()
...

  {
    ...
    // Insert using new keys.
    lt.insert(Pair<int>(8002,9999));
    lt.insert(Pair<int>(8001,8888));
    lt.insert(Pair<int>(8004,8888));
    assert(lt.size() == 3);
    lt.remove(8004);
    assert(lt.size() == 2);
    cout << "\nPrinting table after inserting 3 new keys and  and 1 removal...\n";
